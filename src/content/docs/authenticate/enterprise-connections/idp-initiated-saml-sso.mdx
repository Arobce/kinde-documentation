...
4. **RelayState** (optional): Configure a default RelayState URL if your IdP supports it. This is where users are redirected after authentication.
    <Aside> If you are using Google Workspace as your Identity Provider, set your RelayState URL in the Start URL field in the Google SAML application settings. </Aside>
